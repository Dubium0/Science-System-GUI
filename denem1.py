...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox.setGeometry(QtCore.QRect(0, 0, 151, 22))
        self.comboBox.setObjectName("comboBox")
        self.frame = QtWidgets.QFrame(self.tab)
        self.frame.setGeometry(QtCore.QRect(-1, 19, 1365, 720))
        ...
        self.myFig1 = MyFigureCanvas(x_len=200, y_range=[0,50], interval=1,index = 0)
        self.lyt.addWidget(self.myFig1,1,1)
        
        self.myFig2 = MyFigureCanvas(x_len=200, y_range=[0,50], interval=1, index = 1)
        self.lyt.addWidget(self.myFig2,1,2)
        
        
        
        self.myFig3 = MyFigureCanvas(x_len=200, y_range=[0,50], interval=1,index = 2)
        self.lyt.addWidget(self.myFig3,2,1)
        
        self.myFig4 = MyFigureCanvas(x_len=200, y_range=[0,50], interval=1,index = 3)
...
class MyFigureCanvas(FigureCanvas):
    ...
    def _update_canvas_(self) -> None:
        ...
        '''
        self._y_.append(round(data_func_list[self.index](), 2))     # Add new datapoint
...
def otherdata():
    ...
    return k
data_func_list = [temperature,pressure,altitude,otherdata]
"""    
